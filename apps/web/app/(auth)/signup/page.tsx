    ...
    <main className="flex min-h-screen items-center justify-center bg-canvas p-4">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-muted">Start protecting your content today</p>
        </div>
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            try {
              const res = await api<{ user: CurrentUser; accessToken: string }>('/auth/signup', {
                method: 'POST',
        ...
        >
          ...
          <label className="mb-4 block">
            ...
            <div className="relative">
              ...
              <input required name="name" type="text" placeholder="John Doe" className="input pl-10" />
            </div>
          </label>
          <label className="mb-4 block">
          ...
          <label className="mb-5 block">
            ...
            <div className="relative">
              ...
              <input required name="password" type={showPw ? 'text' : 'password'} minLength={12} placeholder="Min. 12 characters" className="input pl-10 pr-10" />
          ...
          {error && <div className="mb-4 rounded-xl bg-danger-light p-3 text-sm text-danger">{error}</div>}
